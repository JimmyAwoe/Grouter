...
def build_tokenizer(args, **kwargs):
    ...
    elif args.tokenizer_type == 'GrouterCustomHY':
        from collections import OrderedDict
        from utils_grouter.hunyuan_tokenizer.tokenization_hy import HYTokenizer
        tokenizer = HYTokenizer(args.tokenizer_model)
        tokenizer.unique_identifiers = OrderedDict()
        tokenizer.unique_identifiers['name'] = 'hunyuan_tokenizer'
