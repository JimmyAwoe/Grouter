...
from utils_grouter.megatron_integration.add_argument import _add_grouter_args
...
def add_megatron_arguments(parser: argparse.ArgumentParser):
    ...
    # Add grouter related param
    parser = _add_grouter_args(parser)
...
def parse_args(extra_args_provider=None, ignore_unknown_args=False):
    ...
    # Args to disable MSC
    if hasattr(args, "enable_msc") and not args.enable_msc:
